...
def go(args):
    ...
    random_forest_artifact = wandb.Artifact(
        name=args.output_artifact,
        type="model_export",
        description="Artifact containing random forest model",
        metadata=rf_config
    )
    random_forest_artifact.add_dir("random_forest_dir")
    run.log_artifact(random_forest_artifact)
    ######################################
